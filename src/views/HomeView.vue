<template>
  ...
  <div class="container mx-auto px-4 py-6 ">
    ...
    <MovieList
      ...
      @update:page="movieStore.nowPlaying.page = $event; movieStore.loadNowPlaying()"
    />
    <div v-if="movieStore.popular.error" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
    ...
    <MovieList
      ...
      @update:page="movieStore.popular.page = $event; movieStore.loadPopular()"
    />
    <div v-if="movieStore.topRated.error" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
    ...
    <MovieList
      ...
      @update:page="movieStore.topRated.page = $event; movieStore.loadTopRated()"
    />
    <div v-if="movieStore.upcoming.error" class="bg-red-100 border border-red-400 text-red-700 px-4 py-3 rounded mb-4">
